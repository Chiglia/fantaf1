...
import { PilotiService } from "../../api/services/piloti.service";
import { StatsPiloti } from "../../api/models/stats-piloti";
...
export class DetailsComponent {
  ...
  //         (error) => {
  //           console.error(
  //             "Errore durante l'aggiunta del pilota alla sezione compere:",
  //             error
  //           );
  //         }
  //       );
